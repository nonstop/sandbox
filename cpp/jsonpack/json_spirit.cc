...
#ifdef JSON_SPIRIT_VALUE_ENABLED
void write( const Value& value, std::ostream& os, unsigned int options )
{
    write_stream( value, os, options );
}
std::string write( const Value& value, unsigned int options )
{
...
#ifdef JSON_SPIRIT_MVALUE_ENABLED
void write( const mValue& value, std::ostream& os, unsigned int options )
{
    write_stream( value, os, options );
}

std::string write( const mValue& value, unsigned int options )
{
    return write_string( value, options );
}
...
#if defined( JSON_SPIRIT_WVALUE_ENABLED ) && !defined( BOOST_NO_STD_WSTRING )
void write( const wValue& value, std::wostream& os, unsigned int options )
{
    write_stream( value, os, options );
}

std::wstring write( const wValue& value, unsigned int options )
{
    return write_string( value, options );
}
...
void write( const wmValue& value, std::wostream& os, unsigned int options )
{
    write_stream( value, os, options );
}

std::wstring write( const wmValue& value, unsigned int options )
{
    return write_string( value, options );
}
#endif
