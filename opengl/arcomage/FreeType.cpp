...
extern "C" void initFont(const char* file, size_t sz)
{
    our_font.init(file, sz);
}

extern "C" void printStr(const char* text, float x, float y)
{
    freetype::print(our_font, x, y, text);
}
